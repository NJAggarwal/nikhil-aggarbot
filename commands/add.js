module.exports ={
    name: 'add',
    description: 'Command allows users to add level 3 modules.',
    ...
    async execute(message, args, command, ChannelIds, Discord, client){
            ...
            if (message.channel.id === Y3AddSocialsRoleChannel){
                ...
                do{
                    if (moduleChoices[i] === 'socials'){
                        await member.roles.add(Y3SocialsRole);
                    }
                    i = i + 1
            ...
            if (message.channel.id === Y3SelectDegreeChannel){
                ...
                do {
                    if (moduleChoices[i] === Y3MathematicsPassword){
                        await member.roles.add(Y3MathematicsRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsAndStatisticsPassword){
                        await member.roles.add(Y3MathematicsAndStatisticsRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsAndStatisticsPassword){
                        await member.roles.add(Y3MathematicsAndStatisticsRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsAndPhysicsPassword){
                        await member.roles.add(Y3MathematicsAndPhysicsRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsWithFinancialMathematicsPassword){
                        await member.roles.add(Y3MathematicsWithFinancialMathematicsRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsWithFinancePassword){
                        await member.roles.add(Y3MathematicsWithFinanceRole);
                    }
                    if (moduleChoices[i] === Y3ActuarialScienceAndMathematicsPassword){
                        await member.roles.add(Y3ActuarialScienceAndMathematicsRole);
                    }
                    if (moduleChoices[i] === Y3ComputerScienceAndMathematicsPassword){
                        await member.roles.add(Y3ComputerScienceAndMathematicsRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsAndPhilosphyPassword){
                        await member.roles.add(Y3MathematicsAndPhilosphyRole);
                    }
                    if (moduleChoices[i] === Y3MathematicsWithModernLanguagePassword){
                        await member.roles.add(Y3MathematicsWithModernLanguageRole);
                    }
                    i = i + 1
                } while(i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === Y3Semester1Channel){
                ...
                do {            
                    if(moduleChoices[i] === MATH30000Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH30000Role); 
                    }
                    if(moduleChoices[i] === MATH30011Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH30011Role);
                    }
                    if(moduleChoices[i] === MATH32001Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH32001Role);
                    }
                    if(moduleChoices[i] === MATH32051Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH32051Role);
                    }
                    if(moduleChoices[i] === MATH32091Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH32091Role);
                    }
                    if(moduleChoices[i] === MATH33011Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH33011Role);
                    }
                    if(moduleChoices[i] === MATH34011Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH34011Role);
                    }
                    if(moduleChoices[i] === MATH35001Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH35001Role);
                    }
                    if(moduleChoices[i] === MATH35021Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH35021Role);
                    }
                    if(moduleChoices[i] === MATH36001Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH36001Role);
                    }
                    if(moduleChoices[i] === MATH36031Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH36031Role);
                    }
                    if(moduleChoices[i] === MATH38001Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH38001Role);
                    }
                    if(moduleChoices[i] === MATH38141Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH38141Role);
                    }
                    if(moduleChoices[i] === MATH38161Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH38161Role);
                    }
                    if(moduleChoices[i] === MATH39511Letter){
                        await member.roles.add(Y3SEMESTER1Role);
                        await member.roles.add(MATH39511Role);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === Y3Semester2Channel){
                ...
                do{
                    if(moduleChoices[i] === MATH30002Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH30002Role)
                    }
                    if(moduleChoices[i] === MATH30022Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH30022Role)
                    }
                    if(moduleChoices[i] === MATH31042Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH31042Role)
                    }
                    if(moduleChoices[i] === MATH31052Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH31052Role)
                    }
                    if(moduleChoices[i] === MATH32012Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH32012Role)
                    }
                    if(moduleChoices[i] === MATH32032Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH32032Role)
                    }
                    if(moduleChoices[i] === MATH32062Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH32062Role)
                    }
                    if(moduleChoices[i] === MATH32072Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH32072Role)
                    }
                    if(moduleChoices[i] === MATH34032Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH34032Role)
                    }
                    if(moduleChoices[i] === MATH35012Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH35012Role)
                    }
                    if(moduleChoices[i] === MATH35032Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH35032Role)
                    }
                    if(moduleChoices[i] === MATH35062Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH35062Role)
                    }
                    if(moduleChoices[i] === MATH35082Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH35082Role)
                    }
                    if(moduleChoices[i] === MATH36022Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH36022Role)
                    }
                    if(moduleChoices[i] === MATH36062Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH36062Role)
                    }
                    if(moduleChoices[i] === MATH37002Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH37002Role)
                    }
                    if(moduleChoices[i] === MATH37012Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH37012Role)
                    }
                    if(moduleChoices[i] === MATH38032Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH38032Role)
                    }
                    if(moduleChoices[i] === MATH38072Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH38072Role)
                    }
                    if(moduleChoices[i] === MATH38172Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH38172Role)
                    }
                    if(moduleChoices[i] === MATH39032Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH39032Role)
                    }
                    if(moduleChoices[i] === MATH39512Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH39512Role)
                    }
                    if(moduleChoices[i] === MATH39522Letter){
                        await member.roles.add(Y3SEMESTER2Role);
                        await member.roles.add(MATH39522Role)
                    }
            ...
            if (message.channel.id === Y3OutsideModulesChannel){
                ...
                do{
                    if(moduleChoices[i] === Y3PhysPassword){
                        await member.roles.add(Y3PhysRole);
                    }
                    if(moduleChoices[i] === Y3BmanPassword){
                        await member.roles.add(Y3BmanRole);
                    }
                    if(moduleChoices[i] === Y3CompPassword){
                        await member.roles.add(Y3CompRole);
                    }
                    if(moduleChoices[i] === Y3PhilPassword){
                        await member.roles.add(Y3PhilRole);
                    }
                    if(moduleChoices[i] === Y3LangPassword){
                        await member.roles.add(Y3LangRole);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
        ...
        if (message.guild.id === '786260531916832798'){
            ...
            if (message.channel.id === Y2AddSocialsRoleChannel){
                ...
                do{
                    if (moduleChoices[i] === 'socials'){
                        await member.roles.add(Y2SocialsRole);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === Y2SelectDegreeChannel){
                ...
                do{
                    if (moduleChoices[i] === Y2MathematicsPassword){
                        await member.roles.add(Y2MathematicsRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsAndStatisticsPassword){
                        await member.roles.add(Y2MathematicsAndStatisticsRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsAndStatisticsPassword){
                        await member.roles.add(Y2MathematicsAndStatisticsRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsAndPhysicsPassword){
                        await member.roles.add(Y2MathematicsAndPhysicsRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsWithFinancialMathematicsPassword){
                        await member.roles.add(Y2MathematicsWithFinancialMathematicsRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsWithFinancePassword){
                        await member.roles.add(Y2MathematicsWithFinanceRole);
                    }
                    if (moduleChoices[i] === Y2ActuarialScienceAndMathematicsPassword){
                        await member.roles.add(Y2ActuarialScienceAndMathematicsRole);
                    }
                    if (moduleChoices[i] === Y2ComputerScienceAndMathematicsPassword){
                        await member.roles.add(Y2ComputerScienceAndMathematicsRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsAndPhilosphyPassword){
                        await member.roles.add(Y2MathematicsAndPhilosphyRole);
                    }
                    if (moduleChoices[i] === Y2MathematicsWithModernLanguagePassword){
                        await member.roles.add(Y2MathematicsWithModernLanguageRole);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === Y2Semester1Channel){
                ...
                do{
                    if(moduleChoices[i] === MATH20101Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20101Role);
                    }
                    if(moduleChoices[i] === MATH20111Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20111Role);
                    }
                    if(moduleChoices[i] === MATH20201Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20201Role);
                    }
                    if(moduleChoices[i] === MATH20401Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20401Role);
                    }
                    if(moduleChoices[i] === MATH20411Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20411Role);
                    }
                    if(moduleChoices[i] === MATH20621Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20621Role);
                    }
                    if(moduleChoices[i] === MATH20701Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20701Role);
                    }
                    if(moduleChoices[i] === MATH20811Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20811Role);
                    }
                    if(moduleChoices[i] === MATH20951Letter){
                        await member.roles.add(Y2SEMESTER1Role);
                        await member.roles.add(MATH20951Role);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === Y2Semester2Channel){
                ...
                do{
                    if(moduleChoices[i] === MATH20062Letter){
                        ...
                        await member.roles.add(MATH20062Role);
                    }
                    if(moduleChoices[i] === MATH20122Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20122Role);
                    }
                    if(moduleChoices[i] === MATH20132Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20132Role);
                    }
                    if(moduleChoices[i] === MATH29142Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH29142Role);
                    }
                    if(moduleChoices[i] === MATH20212Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20212Role);
                    }
                    if(moduleChoices[i] === MATH20222Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20222Role);
                    }
                    if(moduleChoices[i] === MATH20502Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20502Role);
                    }
                    if(moduleChoices[i] === MATH20512Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20512Role);
                    }
                    if(moduleChoices[i] === MATH20522Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20522Role);
                    }
                    if(moduleChoices[i] === MATH20602Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20602Role);
                    }
                    if(moduleChoices[i] === MATH20712Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20712Role);
                    }
                    if(moduleChoices[i] === MATH20722Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20722Role);
                    }
                    if(moduleChoices[i] === MATH20802Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20802Role);
                    }
                    if(moduleChoices[i] === MATH20902Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20902Role);
                    }
                    if(moduleChoices[i] === MATH20912Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20912Role);
                    }
                    if(moduleChoices[i] === MATH20962Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20962Role);
                    }
                    if(moduleChoices[i] === MATH20972Letter){
                        await member.roles.add(Y2SEMESTER2Role);
                        await member.roles.add(MATH20972Role);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === Y2OutsideModulesChannel){
                ...
                do{
                    if(moduleChoices[i] === Y2PhysPassword){
                        await member.roles.add(Y2PhysRole);
                    }
                    if(moduleChoices[i] === Y2BmanPassword){
                        await member.roles.add(Y2BmanRole);
                    }
                    if(moduleChoices[i] === Y2CompPassword){
                        await member.roles.add(Y2CompRole);
                    }
                    if(moduleChoices[i] === Y2PhilPassword){
                        await member.roles.add(Y2PhilRole);
                    }
                    if(moduleChoices[i] === Y2LangPassword){
                        await member.roles.add(Y2LangRole);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
        ...
        if (message.guild.id === '855360915221774366'){
            ...
            if (message.channel.id === Y1AddSocialsRoleChannel) {
                ...
                do {
                    if (moduleChoices[i] === 'socials') {
                        await member.roles.add(Y1SocialsRole);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if(message.channel.id === Y1Channel){
                ...
                do{
                    if (moduleChoices[i] === MathematicsPassword){
                        await member.roles.add(MathematicsRole);
                        await member.roles.add(Y1SEMESTER1Role);
                        await member.roles.add(MATH10001Role);
                    ...
                    if (moduleChoices[i] === MathematicsAndStatisticsPassword){
                        await member.roles.add(MathematicsAndStatisticsRole);
                        await member.roles.add(Y1SEMESTER1Role);
                        await member.roles.add(MATH10001Role);
                        await member.roles.add(MATH10101Role);
                        await member.roles.add(MATH10121Role);
                    ...
                    if (moduleChoices[i] === MathematicsAndPhysicsPassword){
                        await member.roles.add(MathematicsAndPhysicsRole);
                        await member.roles.add(Y1SEMESTER1Role);
                    ...
                    if (moduleChoices[i] === MathematicsWithFinancialMathematicsPassword){
                        await member.roles.add(MathematicsWithFinancialMathematicsRole);
                        await member.roles.add(Y1SEMESTER1Role);
                        await member.roles.add(MATH10001Role);
                        await member.roles.add(MATH10101Role);
                        await member.roles.add(MATH10121Role);
                    ...
                    if (moduleChoices[i] === MathematicsWithFinancePassword){
                        await member.roles.add(MathematicsWithFinanceRole);
                        await member.roles.add(Y1SEMESTER1Role);
                        await member.roles.add(MATH10001Role);
                        await member.roles.add(MATH10111Role);
                    ...
                    if (moduleChoices[i] === ActuarialScienceAndMathematicsPassword){
                        await member.roles.add(ActuarialScienceAndMathematicsRole);
                        await member.roles.add(Y1SEMESTER1Role);
                        await member.roles.add(MATH10111Role);
                        await member.roles.add(MATH10131Role);
                        await member.roles.add(MATH10141Role);
                    ...
                    if (moduleChoices[i] === MathematicsAndPhilosphyPassword){
                        await member.roles.add(MathematicsAndPhilosphyRole);
                        await member.roles.add(Y1SEMESTER1Role);
                        await member.roles.add(MATH10111Role);
                        await member.roles.add(MATH10131Role);
                        await member.roles.add(Y1SEMESTER2Role);
        ...
        if (message.guild.id === '875621155510321183'){
            ...
            //FIND FOUNDATION YEAR SEMESTER 1 ROLES
            ...
            //FIND FOUNDATION YEAR SEMESTER 2 ROLES
            ...
            if (message.channel.id === FyAddSocialsRoleChannel) {
                ...
                do {
                    if (moduleChoices[i] === 'socials') {
                        await member.roles.add(FySocialsRole);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === AddDepartmentChannel){
                ...
                do{
                    if (moduleChoices[i] === DoMathematics_Password){
                        await member.roles.add(DoMathematics_Role);
                    }
                    if (moduleChoices[i] === DoPaA_Password){
                        await member.roles.add(DoPaA_Role);
                    }
                    if (moduleChoices[i] === DoC_Password){
                        await member.roles.add(DoC_Role);
                    }
                    if (moduleChoices[i] === DoEES_Password){
                        await member.roles.add(DoEES_Role);
                    }
                    if (moduleChoices[i] === DoMaterials_Password){
                        await member.roles.add(DoMaterials_Role);
                    }
                    if (moduleChoices[i] === DoCS_Password){
                        await member.roles.add(DoCS_Role);
                    }
                    if (moduleChoices[i] === DoCEaAS_Password){
                        await member.roles.add(DoCEaAS_Role);
                    }
                    if (moduleChoices[i] === DoMACE_Password){
                        await member.roles.add(DoMACE_Role);
                    }
                    if (moduleChoices[i] === DoEEE_Password){
                        await member.roles.add(DoEEE_Role);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === FySemester1Channel){
                ...
                do{
                    if(moduleChoices[i] === MATH19801Letter){
                        await member.roles.add(FySEMESTER1Role);
                        await member.roles.add(MATH19801Role);
                    }
                    if(moduleChoices[i] === MATH19821Letter){
                        await member.roles.add(FySEMESTER1Role);
                        await member.roles.add(MATH19821Role);
                    }
                    if(moduleChoices[i] === MATH19861Letter){
                        await member.roles.add(FySEMESTER1Role);
                        await member.roles.add(MATH19861Role);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
            ...
            if (message.channel.id === FySemester2Channel){
                ...
                do{
                    if(moduleChoices[i] === MATH19812Letter){
                        await member.roles.add(FySEMESTER2Role);
                        await member.roles.add(MATH19812Role);
                    }
                    if(moduleChoices[i] === MATH19832Letter){
                        await member.roles.add(FySEMESTER2Role);
                        await member.roles.add(MATH19832Role);
                    }
                    if(moduleChoices[i] === MATH19842Letter){
                        await member.roles.add(FySEMESTER2Role);
                        await member.roles.add(MATH19842Role);
                    }
                    if(moduleChoices[i] === MATH19852Letter){
                        await member.roles.add(FySEMESTER2Role);
                        await member.roles.add(MATH19852Role);
                    }
                    if(moduleChoices[i] === MATH19872Letter){
                        await member.roles.add(FySEMESTER2Role);
                        await member.roles.add(MATH19872Role);
                    }
                    i = i + 1
                } while (i < moduleChoices.length + 1)
            }
