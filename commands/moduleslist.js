    ...
    async execute(message, args, command, ChannelIds, Discord, client){
        ...
        if (message.channel.id === '880740835111628820' || message.channel.id === '880732668680081439'){
            ...
            let embed = new Discord.MessageEmbed()
                ...
                + ' into the channel.\n\n'
                + `**N.b.** Messaging $add ${physEmoji} will not work! You need to type in $add rocket.`
                + ' Please see the description for more guidance. \n\n' 
                + `${physEmoji} PHYS \n\n`
                + `${bmanEmoji} BMAN \n\n`
                + `${compEmoji} COMP \n\n`
        ...
        if (message.channel.id === '875754076313378866'){
            ...
            let embed = new Discord.MessageEmbed()
                ...
                + ' into the channel.\n\n'
                + `**N.b.** Messaging $add ${DoMathematics_Emoji} will not work! You need to type in $add nerd.`
                + ' Please see the description for more guidance. \n\n' 
